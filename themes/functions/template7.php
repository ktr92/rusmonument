...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-8">
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление <span class="greenmark">парковых</span> скульптур под заказ</h1>									
									</div>
										...
										<div class="fitches__items">
											<div class="fitches__item">
												<div class="fitches__content">
													...
													<div class="fitches__text"><span>Более 100 выполненных <br>проектов</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches2.png" alt=""></div>
													<div class="fitches__text"><span>Авторский надзор на <br>протяжении всех этапов</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/gar6.png" alt=""></div>
													<div class="fitches__text"><span>Типовые решения или <br>индивидуально под заказ</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/gar7.png" alt=""></div>
													<div class="fitches__text"><span>Помощь в доставке<br> и установке</span></div>
												</div>
											</div>
								...
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image14.png" alt=""></div>
								</div>
							</div>
						</div>
				...
				<div class="garant__main">
						...
						<div class="garant__item">
							<div class="garant__content">
								...
								<div class="garant__right">
									<div class="garant__title">Для оформления парков<br/> и скверов</div>
									<div class="garant__text">Создаются фигуры популярных героев<br/>
										книг или фильмов.</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="garant__content">
								...
								<div class="garant__right">
									<div class="garant__title">Для городского<br/> оформления</div>
									<div class="garant__text">Фигуры создаются для привлечения<br/>
										внимания туристов, могут быть<br/>
										изображены знаменательные жители<br/>
										города, символы города, персонажи<br/>
										городских легенд или увековечено<br/>
										местное ремесло
										</div>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="garant__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us7.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="garant__title">Для ландшафтного<br/> оформления</div>
									<div class="garant__text">Создаются фигуры сказочных<br/>
										персонажей или животных для<br/>
										оформления садов . Используются<br/>
										материалы металл или стеклопластик,<br/>
										облегченный материал, по внешнему<br/>
										виду идентичен металлу.</div>
								</div>
							</div>
						</div>
						</div>
		...
		<div class="">
			<div class="container">
				...
				<div class="materials3">
					<div class="row">
						<div class="col-md-6"><img src="/images/bronza3.png" alt=""></div>
						<div class="col-md-6"><img src="/images/steklpl3.png" alt=""></div>
					</div>
				</div>
		...
		<div class="stagesblock stagesblock_bg" id="block1" style="background-image: none; padding-bottom: 0; background: none;">
			<div class="container">
				<div class="title ">
						<h2>Что входит в изготовление <br><strong>скульптур под заказ?</strong></h2>
		...
		<div class="works">
			...
			<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="10">
			</div>
		</div>
