<?php
/**
 * Шаблон - Мемориальная скульптура
 *
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-8">
									...
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление <span class="greenmark">мемориальных скульптур</span> </h1>									
									</div>
									<div class="topmain__pagedescr">от бюста до фигуры в полный рост</div>
									
									
								</div>
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image11.png" alt=""></div>
								</div>
							</div>
						</div>
		...
		<main>
			...
			<div class="container">
				<div class="title">
					<h2>Что такое <br/><strong>мемориальная скульптура?</strong></h2>
				</div>
				
				<div class="textsrow textsrow2">
					<div class="row">
						<div class="col-md-6">
							<div class="text"><span class="greenmark">Память</span></div>
							<div class="text text_big">
								<p>Мемориальная скульптура позволяет увековечить память на<br/>
									многие годы</p>
									<p>Обычно в такой скульптуре отражается образ человека, его<br/>
									достижения или сфера деятельности.</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="text"><span class="greenmark">Сходство</span></div>
							<div class="text text_big">
								<p>Как и в любой скульптуре, здесь важно передать точное сходство<br/>
								с человеком.</p>
							</div>
						</div>
					</div>
				...
				<div class="blockquote blockquote2">
					<blockquote>«Скульпторы объединения РМС имеют многолетний опыт в изготовлении разного рода скульптур и смогут<br/> в точности передать мимику, черты лица.»</blockquote>
				</div>
				...
				<div class="products__list">
					<div class="row">
						<div class="col-md-6">
							<div class="products__item">
								<div class="products__content">
									<div class="products__img"><img src="/images/img10.png" alt=""></div>
									<div class="products__right">
										<div class="products__title">Скульптура <br/>в полный рост</div>
										<div class="products__text">высота до 200 см</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6" style="margin-top: 30px;">
							<div class="products__item">
								<div class="products__content">
									<div class="products__img"><img src="/images/img11.png" alt=""></div>
									<div class="products__right">
										<div class="products__title">Бюст</div>
										<div class="products__text">высота до 60 см</div>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="works">
			<div class="container">
				...
				<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="6">
			</div>
		</div>
