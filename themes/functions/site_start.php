...
<div class="content"> 
				...
				<div class="container">
					<div class="topmain">
						<div class="topmain__content wow fade-in">
							<div class="row">
								<div class="col-md-7">
									<div class="topmain__title">
										<h1>Российская монументальная скульптура</h1>									
									</div>
									<div class="topmain__descr">Изготовление скульптур напрямую <br/><span>от исполнителя</span></div>
								</div>
								<div class="col-md-5">
									<div class="topmain__image"><img data-src="/images/image1.png" alt=""></div>
								</div>
							</div>
						</div>
						<div class="goto"><a href="#block1" class="scrollto"><img data-src="/images/chevron_down.png" alt=""></a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<main>
		    ...
		    <div style="opacity: 0;height:0;width:0;overflow:hidden">
		        <img data-src="/images/services1-1.jpg">
		        <img data-src="/images/services2-2.jpg">
		        <img data-src="/images/services3-2.jpg">
		        <img data-src="/images/services12-2.jpg">
		        <img data-src="/images/services22-2.jpg">
		        <img data-src="/images/services32-2.jpg">
		        <img data-src="/images/services13-2.jpg">
		        <img data-src="/images/services23-2.jpg">
		        <img data-src="/images/services33-2.jpg">
		        <img data-src="/images/services43-2.jpg">
		         <img data-src="/images/services14-2.jpg">
		          <img data-src="/images/services24-2.jpg">
		           <img data-src="/images/services34-2.jpg">
		            <img data-src="/images/services44-2.jpg"> <img data-src="/images/services34-2.jpg">
		        
		    </div>
		
			<div class="servicesblock" id="block1">
			<div class="container">
				<div class="services">
					<div class="services__cols">
						<div class="row">
							<div class="col-md-3">
								<div class="services__col services__col_1">
									<div class="services__title"><h2>Наши услуги</h2></div>
									<div class="services__row">
										<a href="/izgotovlenie-skulptur/"><div class="services__item services__item_11">
											
												<div class="services__link"><span>Изготовление</span><br/> <span>скульптур</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/skulptura-iz-stekloplastika/"><div class="services__item services__item_21">
											
												<div class="services__link"><span>Скульптура</span><br/> <span>из стеклопластика</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/monumentalnaya-skulptura/"><div class="services__item services__item_31">
											
												<div class="services__link"><span>Монументальная</span><br/> <span>скульптура</span></div>
							...
							<div class="col-md-3">
								<div class="services__col services__col_2">
									
									<div class="services__row">
										<a href="/izgotovlenie-skultur-iz-bronzy/"><div class="services__item services__item_12">
											
												<div class="services__link"><span>Изготовление</span><br/> <span>скульптур из бронзы</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
											<a href="/parkovaya-skulptura/"><div class="services__item services__item_22">
										
												<div class="services__link"><span>Парковая</span><br/> <span>скульптура</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/pravoslavnaya-skulptura/"><div class="services__item services__item_32">
											
												<div class="services__link"><span>Православная</span><br/> <span>скульптура</span></div>
							...
							<div class="col-md-3">
								<div class="services__col services__col_3">
									
									<div class="services__row">
										<a href="/khudozhestvennoe-lite/"><div class="services__item services__item_13">
											
												<div class="services__link"><span>Художественное </span><br/> <span>литье</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/statuetki/"><div class="services__item services__item_23">
											
												<div class="services__link"><span>Статуэтки</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/memorialnye-doski/"><div class="services__item services__item_33">
											
												<div class="services__link"><span>Мемориальные</span><br/> <span> доски</span></div>
											
										</div></a>
									</div>
									
									<div class="services__row">
										<a href="/skulptury-dlya-fontanov/"><div class="services__item services__item_43">
											
												<div class="services__link"><span>Скульптуры</span><br/> <span>для фонтанов</span></div>
							...
							<div class="col-md-3">
								<div class="services__col services__col_4">
									
									<div class="services__row">
										<a href="/izgotovlenie-byustov/"><div class="services__item services__item_14">
											
												<div class="services__link"><span>Изготовление </span><br/> <span>бюста</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/izgotovlenie-skultur/"><div class="services__item services__item_24">
											
												<div class="services__link"><span>Услуги</span><br/> <span>  скульптора</span></div>
											
										</div></a>
									</div>
								
									<div class="services__row">
										<a href="/memorialnaya-skulptura/"><div class="services__item services__item_34">
											
												<div class="services__link"><span>Мемориальная</span><br/> <span> скульптура</span></div>
											
										</div></a>
									</div>
									
									<div class="services__row">
										<a href="/statuetki/"><div class="services__item services__item_44">
											
												<div class="services__link"><span>Кабинетная</span><br/> <span>скульптура</span></div>
		...
		<div class="aboutblock">
			<div class="container">
				<div class="about">
					<div class="title">
						<h2>Об объединении <br/><strong>Российской монументальной скультуры</strong></h2>
					</div>
					<div class="about__items">
						<div class="row">
							<div class="col-md-4">
								<div class="about__item">
									<div class="about__title">
										<div class="marked"><span>Только профессионалы</span></div>
									</div>
									<div class="about__text">
										<p>В нашем объединении работают только скульпторы
											с высшим художественным образованием и
											непрерывным стажем работы и многочисленными
											наградами.
											</p>
									</div>
								</div>
							...
							<div class="col-md-4">
								<div class="about__item">
									<div class="about__title">
										<div class="marked"><span>Работаем по всему миру</span></div>
									</div>
									<div class="about__text">
										<p>Мы работаем по всему миру. Творческие работы
											хранятся в частных коллекциях в России и за
											рубежом в том числе в коллекции Стивена Сигала</p>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="about__item">
									<div class="about__title">
										<div class="marked"><span>Опыт работы >18 лет</span></div>
									</div>
									<div class="about__text">
										<p>Мы работаем в данной сфере более 18 лет. За это
											время мы установли 578 памятников и произвели
											более 5 000 статуэток.</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="about__bottom">
						<div class="blockquote">
							<blockquote>«Монументы отличаются высочайшим качеством исполнения, профессионализмом<br/> и индивидуальным творческим подходом к каждому из них»</blockquote>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-md-3">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Заявка</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
						<div class="col-md-3 offset-md-1">
							<div class="stages__item stages__item_center">
								<div class="stages__title">
									...
									<div class="stages__name">Обработка</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
						<div class="col-md-3 offset-md-1">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Производство</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Согласование</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
						<div class="col-md-3 offset-md-1">
							<div class="stages__item stages__item_center">
								<div class="stages__title">
									...
									<div class="stages__name">Оплата</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
						<div class="col-md-3 offset-md-1">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Установка</div>
								</div>
								<div class="stages__text"><span class="text">Оставьте заявку на сайте или позвоните по номеру <b>8 800 333-25-11</b></span></div>
							</div>
						</div>
									...
									<div class="contacts">
										...
										<div class="contacts__items">
											...
											<div class="contacts__item">
												...
												<div class="contacts__text">
													<div class="email"><a href="mailto:zakaz@rms.ru">zakaz@rms.ru</a></div>
												</div>
											</div>
										</div>
									</div>
