<?php
/**
 * Шаблон - Православная скульптура
 *
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-8">
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление <span class="greenmark">православной скульптуры</span></h1>									
									</div>
										...
										<div class="fitches__items">
											<div class="fitches__item">
												<div class="fitches__content">
													...
													<div class="fitches__text"><span>Выполнено <br>более 40 работ</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
											...
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches6.png" alt=""></div>
													<div class="fitches__text"><span>Авторский надзор на протяжении<br> всех этапов изготовления</span></div>
												</div>
											</div>
								...
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image10.png" alt=""></div>
								</div>
							</div>
						</div>
		...
		<div class="using using_texts" id="block1">
			<div class="container">
				<div class="title ">
					<h2><strong>Православная <br/>скульптура</strong></h2>
				</div>
						<div class="textsrow">
							<div class="row">
								<div class="col-md-6">
									<div class="text text_big">
										<p>Создание православной скульптуры необходимо придерживаться<br/>
											строгих канонов для изображения символов и обликов. Все должно<br/>
											точно соответствовать традициям. Изготовление православных<br/>
											скульптур не запрещено православной церковью и не нарушает<br/>
											церковных канонов.</p>
									</div>
								</div>
								<div class="col-md-6">
									<div class="textbordered">
										<div class="text">
											<p><b>Важно!</b></p>
											<p>Изготавливаемые скульптуры не являются местом<br/> для поклонения или образом для молитв.</p>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="works">
			...
			<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="11">
			</div>
		</div>
