...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-8">
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление бюстов <span class="greenmark">по фото на заказ</span></h1>									
									</div>
										...
										<div class="fitches__items">
											<div class="fitches__item">
												<div class="fitches__content">
													...
													<div class="fitches__text"><span>Портретное <br/>сходство</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches2.png" alt=""></div>
													<div class="fitches__text"><span>Срок изготовления<br/> 40 дней</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/gar6.png" alt=""></div>
													<div class="fitches__text"><span>Размеры<br/> от 20 до 75 см</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/gar7.png" alt=""></div>
													<div class="fitches__text"><span>Доставка и<br/> установка</span></div>
												</div>
											</div>
								...
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image5.png" alt=""></div>
		...
		<div class="stagesblock stagesblock_bg stagesblock_type2" id="block1">
			<div class="container">
				<div class="title">
						<h2>Основные этапы <br/><strong>изготовления бюста по фото</strong></h2>
					</div>
				<div class="stages__items stages__items_page">
						...
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Фото образец</div>
								</div>
								<div class="stages__text"><span class="text">От Вас необходимо предоставить фото образец,
									чем больше фото с разных углов и ракурсов,
									тем более подробное сходство. </span></div>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="prodtime prodtime_small">
						...
						<div class="prodtime__text">
							...
							<div class="prodtime__text2">
								<span class="prodtime__text21">=</span>
								<span class="prodtime__text22"><span>40 дней</span></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="materials">
					<div class="title title_small">
						<h2><strong><span class="greenmark">Что нужно</span></strong> <br/>для портретного сходства?</h2>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="pagetext">
								<p>Для обеспечения портретного сходства и наиболее детальной<br/>
								передачи эмоций и мимики необходимо несколько фото, желательно с<br/>
								разных ракурсов. Чтобы воссоздать бюст соответствующий оригиналу.</p>

								<p><span style="color: #252761; font-weight: bold;">Но</span>, если у вас нет разных фотографий, наши скульпторы могут<br/>
								изготовить бюст даже по одному фото.</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="pageimg pageimg_top"><img src="/images/image6.png" alt=""></div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6 order-1 order-md-2">
							<div class="materials__left">
								...
								<div class="title title_small">
									<h2><strong><span class="greenmark">Постамент </span></strong> <br/>для бюста</h2>
								</div>
								<div class="textblockquote">
									<p>Для каждого изделия мы можем изготовить постаменты и таблички. </p>
									<p>Эти элементы изготавливаются в общем стиле, чтобы готовый бюст
									выглядел лаконично и эстетично.								</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 order-2 order-md-1">
							<div class="pageimg "><img src="/images/image7.png" alt=""></div>
						</div>
		...
		<div class="materialsblock materialsblock_bg">
			<div class="container">
				<div class="materials">
					<div class="title">
						<h2><strong><span class="greenmark">Материалы</span></strong> <br/>для изготовления скульптур</h2>
					</div>
					<div class="materials__items materials__items4">
						<div class="materials__item">
							<div class="materials__content">
								<div class="materials__name"><span>Бронза</span></div>
								<div class="materials__image"><img src="/images/materials7.png" alt=""></div>
							</div>
						</div>
						
						<div class="materials__item materials__item_top materials__item_rotate">
							<div class="materials__content">
								<div class="materials__name"><span>Мрамор</span></div>
								<div class="materials__image"><img src="/images/materials8.png" alt=""></div>
							</div>
						</div>
						<div class="materials__item">
							<div class="materials__content">
								<div class="materials__name"><span>Гранит</span></div>
								<div class="materials__image"><img src="/images/materials9.png" alt=""></div>
							</div>
						</div>
					
						<div class="materials__item materials__item_top materials__item_font2 materials__item_rotate">
							<div class="materials__content">
								<div class="materials__name"><span class="materials__namesmall">Искуственный</span><br/><span>камень</span></div>
								<div class="materials__image"><img src="/images/materials10.png" alt=""></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="works works_nobg">
			<div class="container">
					<div class="title">
						<h2><strong>Наши работы </strong><br>Объединение Российская монументальная скульптура</div>
			
			
						<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="8">
			</div>
		</div>
