							...
							<div class="row">
								<div class="col-md-8">
									...
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление <span class="greenmark">мемориальных досок</span> </h1>									
									</div>
									<div class="topmain__pagedescr">под заказ</div>
									...
									<div class="fitches">
										<div class="fitches__items">
											...
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches7.png" alt=""></div>
													<div class="fitches__text"><span>Возможность изготовления<br> с барельефом</span></div>
												</div>
											</div>
								...
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image12.png" alt=""></div>
								</div>
							</div>
						</div>
		...
		<div class="using using_bg8">
			<div class="container">
				...
				<div class="textsrow textsrow2">
					<div class="row">
						<div class="col-md-6">
							<div class="text"><span class="greenmark">Мемориальные доски</span></div>
							<div class="text text_big">
								<p>Или памятные доски изготавливаются с целью увековечить<br/>
память о знаменитом человеке или событии. Размещаются на<br/>
фасадах зданий.</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="text"><span class="greenmark">Доски с барельефом</span></div>
							<div class="text text_big">
								<p>Возможно изготовить доску с барельефом - объемным выпуклым <br/>
изображением, относительно плоскости доски. Обычно это<br/>
портрет в профиль или анфас.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="blockquote blockquote2">
					<blockquote>«Изготавливаем памятные доски любой формы, даже нестандартной.»</blockquote>
				</div>
				<br/><br/>
			</div>		
		</div>
					...
					<div class="materials__items materials__items4">
						<div class="materials__item">
							<div class="materials__content">
								...
								<div class="materials__image"><img src="/images/bronza2.png" alt=""></div>
							</div>
						</div>
						...
						<div class="materials__item materials__item_top materials__item_rotate">
							<div class="materials__content">
								...
								<div class="materials__image"><img src="/images/mramor2.png" alt=""></div>
							</div>
						</div>
						...
						<div class="materials__item materials__item_font1">
							<div class="materials__content">
								...
								<div class="materials__image"><img src="/images/steklpl2.png" alt=""></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="stagesblock stagesblock_bg"  style="background-image: none; padding-bottom: 10px;">
			<div class="container">
				<div class="title">
		...
		<div class="works">
			<div class="container">
				...
				<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="7">
			</div>
		</div>
