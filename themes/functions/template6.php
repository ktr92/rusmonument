<?php
/**
 * Шаблон - Скульптура из стеклопластика
 *
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-8">
									<div class="topmain__title topmain__title_page">
										<h1>Изготовление скульптур <span class="greenmark">из стеклопластика</span></h1>									
									</div>
									<div class="topmain__pagedescr">любой формы и размера</div>
									
									
								</div>
								<div class="col-md-4">
									<div class="topmain__image topmain__image_page"><img src="/images/image13.png" alt=""></div>
								</div>
							</div>
						</div>
						<div class="goto goto_page"><a href="#block1" class="scrollto"><img src="/images/chevron_down.png" alt=""></a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<main>
			...
			<div class="stagesblock stagesblock_bg bg15" id="block1">
			<div class="container">
				<div class="title ">
						<h2>Что такое <br/><strong>стеклопластик?</strong></h2>						
					</div>
					
				<div class="text text_big text_margin">
					<p><b style="font-weight: 500;">Бюджетный материал</b>, имитирующий металлы бронзу, мрамор, гранит, который не возможно визуально отличить.<br/>
					Выбирая пластик для изготовления скульптуры вы получите экономичное решение с высоким качеством изготовления.</p>
				</div>
				
				<div class="title">
					<h2><span class="greenmark"><b>Почему стеклопластик?</b></span></h2>
				</div>
						...
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Облегченный материал</div>
								</div>
								<div class="stages__text"><span class="text">Стеклопластик легче металла, поэтому требований
к месту установки скульптуры гораздо меньше, чем
у его металлических изделий. А также их удобно
доставлять и монтировать.</span></div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stages__item stages__item_center">
								<div class="stages__title">
									...
									<div class="stages__name">Цена</div>
								</div>
								<div class="stages__text"><span class="text">Изделия из стеклопластика визуально ни чем не
отличаются от дорогостоящих изделий из бронзы,
мрамора, гранита. Прекрасное решение для
небольших бюджетов.</span></div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Пластичность</div>
								</div>
								<div class="stages__text"><span class="text">Позволяет проработать мелкие детали. Сюда еще
бы текст добавить по хорошему. Прекрасное
решение для небольших бюджетов.</span></div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Срок службы</div>
								</div>
								<div class="stages__text"><span class="text">Стеклопластик крепкий, надежный материал.
Способен выдержать перепады температур, а
также физическое воздействие. Не склонен к
образованию трещит и сколов.</span></div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stages__item stages__item_center">
								<div class="stages__title">
									...
									<div class="stages__name">Покрытие краской</div>
								</div>
								<div class="stages__text"><span class="text">Стеклопластик хорошо взаимодействует с
покрасочным материалом. Устойчив к воздействиям
окружающей среды, влаге. Не требует постоянного
обновления краской.</span></div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									...
									<div class="stages__name">Уход</div>
								</div>
								<div class="stages__text"><span class="text">Изделие из стеклопластика очень легко
поддерживать в хорошем виде. Можно освежить
фигуру, простой водой.</span></div>
							</div>
						</div>
		...
		<div class="using2">
			<div class="container">
				<div class="title">
					<h2><strong>Где можно использовать <br>скульптуры из стеклопластика?</strong></h2>
				</div>
				<div class="garant__main">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us1.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для ландшафтного <br>оформления парков <br>и скверов</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us2.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">На фасадах зданий</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us3.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для ростовых фигур в <br>музеях и на выставках</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us4.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для создания <br>реплик скульптур</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us5.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для рекламы</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/us6.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для интерьера</div>
								</div>
							</div>
						</div>
						</div>
		...
		<div class="works">
			<div class="container">
				...
				<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="9">
			</div>
		</div>
