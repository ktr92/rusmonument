...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-7">
									<div class="topmain__title topmain__title_page">
										<h1><span class="greenmark">Изготовление настольных</span> статуэток из бронзы</h1>									
									</div>
									<div class="topmain__pagedescr">типовые и авторские</div>
										...
										<div class="fitches__items">
											<div class="fitches__item">
												<div class="fitches__content">
													...
													<div class="fitches__text"><span>Изготавливаем <br/>от 1-ой штуки</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches4.png" alt=""></div>
													<div class="fitches__text"><span>Изготавливаем кубки<br/> и медали</span></div>
												</div>
											</div>
											<div class="fitches__item">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/fitches5.png" alt=""></div>
													<div class="fitches__text"><span>Более 100<br/> выполненных работ</span></div>
												</div>
											</div>
								...
								<div class="col-md-5">
									<div class="topmain__image topmain__image_page"><img src="/images/image8.png" alt=""></div>
								</div>
							</div>
						</div>
		...
		<div class="using">
			<div class="container">
				<div class="title">
					<h2><strong>Где используются <br/>бронзовые статуэтки?</strong></h2>
				</div>
				<div class="garant__main">
						...
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/gar8.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для оформления <br/>интерьеров дома или <br/>рабочего стола</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/gar9.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">В качестве<br/> изысканного подарка</div>
								</div>
							</div>
						</div>
						</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="garant__item">
							<div class="using__content">
								<div class="garant__image">
									<div class="garant__img"><img src="/images/gar10.png" alt=""></div>
								</div>
								<div class="garant__right">
									<div class="using__title">Для сувенира или<br/> корпоративной<br/> символики</div>
								</div>
							</div>
						</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="textblockquote">
								...
								<p>В своей работе мы используем бронзовый сплав, так как именно из<br/>
бронзы можно выполнить более детальное литье. Придать<br/>
выразительность образу,  более тонко передать черты лица и<br/>
особенности внешности. Статуэтки из бронзы выглядят очень<br/>
реалистично и естественно.</p>
							</div>
						</div>
						<div class="col-md-6">
				...
				<div class="materials">
					...
					<div class="row">
						...
						<div class="col-md-6 order-1 order-md-2">
							<div class="materials__left materials__left_2">
								
								<div class="title title_small">
									<h2><strong><span class="greenmark">Нанесение</span> гравировки <br/>и тематической символики<br/></strong> на статуэтку</h2>
								</div>
								<div class="textblockquote">
									<p>При желании заказчика мы можем выполнить гравировку или <br/>дополнить статуэтку дополнительными символами</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 order-2 order-md-1">
							<div class="pageimg "><img src="/images/image9.png" alt=""></div>
						</div>
		...
		<div class="products">
			<div class="container">
				<div class="title"><b>В объединении Российская<br/>
					монументальная скульптура <span class="greenmark">вы можете заказать</span>:</b></div>
				...
				<div class="products__list">
					<div class="row">
						<div class="col-md-6">
							<div class="products__item">
								<div class="products__content">
									<div class="products__img"><img src="/images/products1.png" alt=""></div>
									<div class="products__right">
										<div class="products__title">Изготовление <br/>кубков</div>
										<div class="products__text">кубки выполняются в любом<br/>
											размере, типовые или авторские<br/>
											с возможностью нанесения<br/>
											гравировки<br/>
						...
						<div class="col-md-6">
							<div class="products__item">
								<div class="products__content">
									<div class="products__img"><img src="/images/products2.png" alt=""></div>
									<div class="products__right">
										<div class="products__title">Изготовление призов <br/>и сувениров</div>
										<div class="products__text">изготовление корпоративных<br/>
											призов и сувениров из бронзы -<br/>
											любой жанр и тематика</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="products__item">
								<div class="products__content">
									<div class="products__img"><img src="/images/products3.png" alt=""></div>
									<div class="products__right">
										<div class="products__title">Изготовление <br/>медалей</div>
										<div class="products__text">медали из бронзы, возможность <br/>нанесения гравировки</div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-5">
							<div class="textblockquote">
								<p>Мы работаем как с заказом от одной штуки, так и с<br/>
										тиражами из нескольких фигур. Изготавливаем<br/>
										авторские статуэтки по индивидуальному заказу,<br/>
										но также можем изготовить типовые фигурки.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="works">
			<div class="container">
					<div class="title">
						...
						<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="1">
