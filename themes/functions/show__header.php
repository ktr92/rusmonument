<header id="header" class="header">
					<div class="container">
						<div class="header__content">
							...
							<button id="mobile-menu"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 125" version="1.1" x="0px" y="0px"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g fill="#000000">
								<rect x="16" y="21" width="69" height="8"></rect>
								<rect x="16" y="48" width="69" height="8"></rect>
								<rect x="16" y="74" width="69" height="8"></rect></g></g></svg></button>


							<div class="header__items">
								<div class="header__item header__item_logo">
									<div class="header__logo"><a href="/" style="display: block;"><img src="/images/logo.png" alt=""></a></div>
								</div>
								...
								<div class="header__mobilephone"><a href="tel:89169200298"><img src="/images/tel.png" alt=""></a></div>
