...
class Ab extends Controller
{
	...
	{
		$this->diafan->attributes($attributes, 'count', 'site_id', 'cat_id', 'sort', 'images', 'images_variation', 'param', 'only_module', 'only_ab', 'tag', 'template');
	...
	{
		$this->diafan->attributes($attributes, 'site_id', 'cat_id', 'ajax', 'only_module', 'only_ab', 'template');
	...
	{
		$this->diafan->attributes($attributes, 'site_id', 'cat_id', 'only_module', 'only_ab', 'template');
