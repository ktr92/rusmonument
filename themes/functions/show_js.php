...
echo '
<script src="'.BASE_PATH.File::compress('js/bootstrap.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/bootstrap.bundle.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/jquery.mCustomScrollbar.concat.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/jquery.mCustomScrollbar.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/SmoothScroll.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/maskedinput.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/slick.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/wow.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/lightbox.min.js', 'js').'"></script>
<script src="'.BASE_PATH.File::compress('js/scripts.js', 'js').'"></script>
...
window.onload = function(){
    setTimeout(function(){
  	document.getElementById('iframe').src="https://yandex.ru/map-widget/v1/?um=constructor%3Ae3813cf74d3a5d3f242acb72dc6a45b4be0af43b3d153de0eab7ffb1a46eb77e&amp;source=constructor";
     },2000)
}
</script>
