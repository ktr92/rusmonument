<?php
/**
 * Шаблон - Скульптуры для фонтанов
 *
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    6.0
...
<div class="content"> 
							...
							<div class="row">
								<div class="col-md-7">
									<div class="topmain__title topmain__title_page">
										<h1><span class="greenmark">Изготовление скульптур</span> для фонтанов</h1>									
									</div>
									<div class="topmain__pagedescr">напрямую от исполнителя</div>
									
									<div class="fitches">
										<div class="fitches__items">
											<div class="fitches__item fitches__item_error">
												<div class="fitches__content">
													<div class="fitches__icon"><img src="/images/error.png" alt=""></div>
													<div class="fitches__text"><span>Работаем с проектами любых размеров и любой сложности</span></div>
												</div>
											</div>
								...
								<div class="col-md-5">
									<div class="topmain__image topmain__image_page"><img src="/images/img6.png" alt=""></div>
								</div>
							</div>
						</div>
		...
		<div class="stagesblock stagesblock_bg" id="block1">
			<div class="container">
				<div class="title title_flex">
						<h2>Как происходит <br/><strong>изготовление фонтана?</strong></h2>
						<div class="righttext">Изготовление фонтана отличается от изготовления скульптуры тем, что
						подразумевает работу скульпторов и инженеров по проектированию оборудования.
						Дополнительно заводятся необходимые трубы и детали для подачи воды.</div>
					</div>
				<div class="stages__items stages__items_page">
					<div class="row">
						...
						<div class="col-md-4">
							<div class="stages__item">
								<div class="stages__title">
									<div class="stages__number">07.</div>
									<div class="stages__name">Тестирование изделия</div>
								</div>
								<div class="stages__text"><span class="text">Запуск фонтана для проверки  направления и напора воды. При необходимости вносятся корректировки.</span></div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div class="warncontent">
								<div class="pageform__title">Важно!</div>
								<div class="warntext">Предусматриваем место расположения коммуникаций<br/> для <span class="greenmark">удобного обслуживания фонтана</span> в будущем.</div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="works">
			<div class="container">
				...
				<insert name="show_block" module="news" count="100" images="100" template="slider" cat_id="2">
			</div>
		</div>
