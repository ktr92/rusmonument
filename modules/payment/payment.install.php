	...
	public $demo = array(
		"payment" => array(
			...
			array(
				...
				"text" => array('Яндекс.Касса — сервис электронных платежей, с ее помощью можно платить с банковских карт, электронными деньгами, наличными и другими способами. За безопасность сервиса отвечают Яндекс.Деньги.', 'Yandeks.Kassa - electronic payment service, you can use it to pay with bank cards, electronic money, cash or other methods. Security service responsible Yandex.Kassa.'),
				"payment" => 'yandexkassa',
			),
			array(
