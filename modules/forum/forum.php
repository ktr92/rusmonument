...
class Forum extends Controller
{
	...
	{
		$this->diafan->attributes($attributes, 'count', 'block_id', 'cat_id', 'sort', 'only_module', 'template');
	...
	{
		$this->diafan->attributes($attributes, 'count', 'cat_id');
	...
	{
		$this->diafan->attributes($attributes, 'count', 'block_id', 'cat_id', 'only_module', 'template');
